...
exports ['can run a simple test'] = function(test){
  ...
  child.runFile('meta_test/test/examples/asynct/test-all_passing',{onSuiteDone: suiteDone})
...
exports ['accepts test adapter'] = function (test){
  ...
  var callbacks = { adapter: "meta_test/test/lib/dummy_test_adapter" }
  ...
  child = require('meta_test/child2')
  child.runFile("meta_test/test/lib/magic_number" ,callbacks)
}
...
exports ['calls onSuiteDone(\'loadError\') if child did not exit properly.'
  ...
  var callbacks = 
      { adapter: "meta_test/test/lib/dummy_test_adapter" 
      , onSuiteDone: done }
  ...
  child.runFile("meta_test/test/examples/asynct/test-error_syntax" ,callbacks)
}
...
exports ['calls onSuiteDone(\'loadError\') does not confuse stderr with real loadError.'] = function (test) {
  ...
  child = require('async_testing/lib/child2')
  child.runFile("meta_test/test/lib/stderr" ,callbacks)
}
